...
class DeepRecursionException(Exception):
    pass
...
class Network():
    ...
    def performRDS(self, numseeds=3, maxsample=100, numrecurse=0):
        SIM_TIME = 10000
        ...
        if len(sampled) < maxsample * 0.9:
            ...
            return self.performRDS(numseeds=numseeds, maxsample=maxsample, numrecurse=numrecurse+1)
